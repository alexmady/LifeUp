...
var androidPlatformsDir_dist_fonts = path.resolve(__dirname, '../../platforms/android/assets/www/dist/fonts');
...
mv(androidPlatformsDir_dist_fonts, androidPlatformsDir_www_fonts, function(err) {
    if(typeof err != 'undefined')
    {
        console.log("err");
        console.log(err);
        console.log("ERROR when moving fonts to Android platform");
    }
    else
    {
        console.log("fonts moved OK to Android platform");
    }
});
